...
const items = [
  ...
  { id: 'contacts', label: 'Contatti', icon: <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.6" className="w-5 h-5"><path d="M13 9a4 4 0 1 1-8 0 4 4 0 0 1 8 0z"/><path d="M2 18a7 7 0 0 1 14 0"/></svg> },
  ...
  { id: 'pipeline', label: 'Pipeline', icon: <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.6" className="w-5 h-5"><rect x="2" y="2" width="6" height="16" rx="1.5"/><rect x="12" y="2" width="6" height="10" rx="1.5"/></svg> },
]
